...
export const CloseModal = ({
  ...
  return (
    <dialog ref={ref} className='modal rounded-lg h-fit w-1/2 bg-gradient-to-r from-bluish to-greenish-light' onKeyDown={keyDown}>
      <div className='w-fit h-fit flex flex-col p-5 rounded-lg items-center'>
        <span className={taclass}>{displayText}</span>
        <IconWithText
        onClick={closeModal}
