    ...
    <section className='text-center mt-6 flex flex-col align-middle '>
      ...
      <article className='flex-col w-2/3 self-center drop-shadow-md grow mb-auto'>
        ...
        <p className='mt-6 text-pretty '>
          A diverse background in many technologies and software development
          languages, with a focus on solutions over technology stack. An ability
          to assimilate new technologies with a strong desire to always learn
          more and do so quickly.
        </p>
        <p className='mt-6 text-pretty '>
          Enjoys writing code, especially net new projects with involvment
